...
namespace WritingTextToTheOutputWindow
{
    class Program
    {
        ...
        static int Maxima(int[] integers, out int[] indices)
        {
            ...
            indices[0] = 0;
            int count = 1;
            Debug.WriteLine(string.Format($"Maximumn value initialized to {maxVal}, at element index 0."));
            ...
            Trace.WriteLine(string.Format($"Maximum value {maxVal} found, with {count} occurences."));
