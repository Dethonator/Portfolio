    ...
    public class Game
    {
        ...
        public int PlayGame()
        {
            ...
            do
            {
                ...
                {
                    //Write our current player, player hand, and the card on the table.
                    ...
                    while (inputOK == false);
                    // Place reference to removed card in playCard (place the card on the table), then remove card from player hand and add to discarded card pile.
