...
namespace ArrayVersusMoreAdvancedColletions
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Animal[] animalArray = new Animal[2];                                                                        //Array creation
            ...
            ArrayList animalArrayList = new ArrayList();                                                                 //ArrayList creation
            ...
            WriteLine();
            WriteLine("Additional manipulation of ArrayList:");                                                          //Additional ArrayList manipulation
